...
ROOT_URLCONF = 'configuracion_comuna.urls'
...
WSGI_APPLICATION = 'configuracion_comuna.wsgi.application'
...
PASSWORD_HASHERS = [
    ...
    'django.contrib.auth.hashers.BCryptSHA256PasswordHasher', # Para tus claves de PHP
]
